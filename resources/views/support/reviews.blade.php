        ...
        <div class="keen-slider__slide">
          ...
          >
            <div>
              ...
              <div class="mt-4">
                <p class="text-2xl font-bold text-rose-600 sm:text-3xl">Review 1</p>

                <p class="mt-4 leading-relaxed text-gray-700">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras ullamcorper nibh eget imperdiet pellentesque. Cras nisl lacus, cursus vel sapien nec, luctus semper quam. Fusce vitae neque vel turpis commodo suscipit. Ut vestibulum efficitur tempus. Ut convallis augue at blandit bibendum.
                </p>
              </div>
            </div>
        ...
        <div class="keen-slider__slide">
          ...
          >
            <div>
              ...
              <div class="mt-4">
                <p class="text-2xl font-bold text-rose-600 sm:text-3xl">Review 2</p>
        ...
        <div class="keen-slider__slide">
          ...
          >
            <div>
              ...
              <div class="mt-4">
                <p class="text-2xl font-bold text-rose-600 sm:text-3xl">Review 3</p>
